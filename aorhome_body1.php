...
<!-- test -->		
			<div class="row show-for-small-only">
				<div class="small-12 columns rickhead-neg-space container">
					<svg  xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 1440 167">
						<g>
							<clippath  id="shape-divide99">
									<polygon points="0,0,1440,0,1440,47,0,167,0,0"></polygon>
							</clippath>
						</g>
						<image   clip-path="url(#shape-divide99)" width="1440" height="764" xlink:href="img/texture_grey.png" preserveAspectRatio="xMidYMin slice"></image>
					</svg>
				</div>
			</div>
		...
		<div class="row show-for-small-only">
			<div class="small-12 columns rickhome-neg-space">
	 			<svg  xmlns="http://www.w3.org/2000/svg"  width="100%"  viewBox="0 0 1440 350">
        	<g>
            <clippath  id="shape-divide72">
                <polygon points="0,0,1440,0,1440,150,0,115,0,0"></polygon>
            </clippath>
        	</g>
        	<image   clip-path="url(#shape-divide72)" width="1440" height="764" xlink:href="img/texture_brown.png" preserveAspectRatio="xMidYMin slice"></image>
    		</svg>
			</div>
	</div>
	<br><br>
...
<div class="row">
 <div class="small-12 columns sticky"  data-margin-top="0">
...
<!-- end of row with left panel -->
		...
		<div class="row show-for-small-only">
			<div class="small-12 columns rickhome-neg-space gallery-divide-bkg">
		...
		What makes an artist tick? Watch our video interviews and find out!<br>&nbsp;<br>&nbsp;<br>
			...
			<div class="row hide-for-small-only"> <!-- slant down -->
				<div class="rickhome-neg-space gallery-divide-bkg small-12 columns">
					<svg  width="100%"  viewBox="0 0 1440 115">
						<g>
