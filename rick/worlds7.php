				...
				<div class="small-10 column text-center">
					...
					<img id="sizing-image" data-interchange="[img/vs_<?php echo FILENAME_PREFIX; ?>1a_sm.jpg, small], [img/vs_<?php echo FILENAME_PREFIX; ?>1a_lg.jpg, medium]" alt="<?php echo ARTIST; ?>, Artwork">
						...
						<div id="image-overlay-content1" class="video">
							...
							<video controls id="image1" src="img/<?php echo FILENAME_PREFIX; ?>1a_lg.mp4">
       				</video> 
...
<a href="#" class="tb" id="tb1"><img class="thumbnail" src="img/<?php echo FILENAME_PREFIX; ?>1a_tb.jpg"></a>
</div>
...
<div class="column gallery">
<a href="#" class="tb" id="tb<?php echo $img_count; ?>"><img class="thumbnail" src="img/<?php echo FILENAME_PREFIX; ?><?php echo $img_count; ?>a_tb.jpg"></a>
</div>
<?php } ?>
