...
<!-- divider row LARGE-->
			<!--<div class="row"> 
				<div class="wedge  foot-container small-12 columns">
					...
					<svg  width="105%"  viewBox="0 0 1440 115">
						...
						<image   clip-path="url(#shape-divide5)" width="1440" height="764" xlink:href="../img/texture_blue.png" preserveAspectRatio="xMidYMin slice"></image>
					</svg>
				</div>
			</div>-->
	 ...
	 <svg  width="105%"  viewBox="0 0 1440 115">
						...
						<div class="row divide-row">
								<div  class="small-12 medium-8 columns divide-label-lg">
									<!--<h5 class="rick-font divide-content-lg"><?php //echo GALLERY_NAME ?> Gallery</h5>-->
								</div>
