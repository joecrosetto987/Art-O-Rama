...
function twitterShare() {
    ...
    //Open the window.
		window.open("https://twitter.com/intent/tweet?text=Please%20look%20at%20this%20fantastic%20art:&url=" + location.protocol+"//"+location.host+location.pathname + "&via=aorgallery", "", "width=550,height=420,resizable=yes,left=" + leftPosition + ",top=" + topPosition + ",screenX=" + leftPosition + ",screenY=" + topPosition + ",toolbar=no,menubar=no,scrollbars=no,location=no,directories=no");
}
