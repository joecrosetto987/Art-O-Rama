 ...
 <div class="off-canvas-content" data-off-canvas-content>
	...
	<div class="row" data-equalizer data-equalize-on="medium" id="test-eq">
		...
		<div  class="aorhome_left_panel medium-8  small-12 columns" data-equalizer-watch>
			<div class="row margin-zero aorhome-mainrow">

<!-- begin new code -->

	<div class="small-1 column text-center divarrow" >
		...
		<div class="row small-up-2 large-up-3">
			...
			<div class="thumb column">
				<a href="joemug/jpcd.php">
					<div class="media"> 
					<img src="img/jpcd1a_tb.jpg" class="th" alt="Thumbnail for Drawings by John Colson">
					  <div class="media__body">
...
<div class="aorhome-tb-cont"><a href="joemug/index.php"><img class="aorhome-tb" src=img/aorhome_mugajoe3.jpg></a></div><br>
<h5><a class="aor-font" href="joemug/index.php">Mug a Joe</a></h5>
<p class="dotted-line">Check out these one-of-a kind, handmade mugs by Joe Crosetto!<br>&nbsp;<br></p> -->
