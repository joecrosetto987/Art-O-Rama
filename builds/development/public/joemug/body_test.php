	 	 ...
	 	 <div class="row main-image">
				...
				<div class="small-10 column text-center">
					...
					<img id="sizing-image" data-interchange="[img/vs_<?php echo FILENAME_PREFIX; ?>1a_sm.jpg, small], [img/vs_<?php echo FILENAME_PREFIX; ?>1a_lg.jpg, medium]" alt="<?php echo ARTIST; ?>, Artwork">
						...
						<!-- PHP loop of images -->
							<?php 
								...
								<?php $pic_num = $art["art_pic_num"]; ?>
								
									<div id="image-overlay-content<?php echo $img_count; ?>">
								<img id="image<?php echo $img_count; ?>" data-interchange="[img/<?php echo FILENAME_PREFIX; ?><?php echo $pic_num; ?>a_sm.jpg, small], [img/<?php echo FILENAME_PREFIX; ?><?php echo $pic_num; ?>a_lg.jpg, medium]" alt="<?php echo ARTIST; ?> <?php echo htmlentities($art["art_title"]); ?>">
						</div>
					...
					<!-- this is a final slide that thanks visitors and asks them to go to the rick home page -->
						...
						<?php $pic_num ++; ?>
						<div id="image-overlay-content<?php echo $img_count; ?>">
						<img id="image<?php echo $img_count; ?>" data-interchange="[img/<?php echo FILENAME_PREFIX; ?><?php echo $pic_num; ?>a_sm.jpg, small], [img/<?php echo FILENAME_PREFIX; ?><?php echo $pic_num; ?>a_lg.jpg, medium]" alt="<?php echo ARTIST; ?>">
						</div>	
...
<div class="column gallery">
<a href="#" class="tb" id="tb<?php echo $img_count; ?>"><img class="not-viewed" src="img/<?php echo FILENAME_PREFIX; ?><?php echo $pic_num; ?>a_tb.jpg"></a>
</div>
<?php } ?>
