...
function handleAi(e) {
	...
	var	imageFileName = imgFolder + "/" + filenamePrefix + img_num_letter  + curImageSize + "." + curImageExt;
 ...
 // var newImage = document.getElementById(imageName);
  if (curImage.height > curImage.width) {
    curImage.style.padding = "0 15%";
  } else {
    curImage.style.padding = "0";
  }
...
//can't get this function to work! not currently called
function unhighlightAi() {
	var numberOfAi = 1;
	var chr = String.fromCharCode(96 + numberOfAi);
	var aiName = "jj" + curImageNum + chr;
	var myAi = document.getElementById(aiName);
	while (myAi !== null) {
//		myAi.firstElementChild.src = "joe_blow";
		myAi.firstElementChild.setAttribute('class', '');
		numberOfAi ++;
		chr = String.fromCharCode(96 + numberOfAi);
		aiName = curImageNum + chr;
		myAi = document.getElementById(aiName);
	}
}
