...
$checkc = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM contacts WHERE contact_id = ".$data[0].""));
...
//INSERT NEW RECORDS
mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO contacts (contact_first, contact_last, contact_title, contact_company, contact_street, contact_city, contact_state, contact_zip, contact_country, contact_email, contact_phone, contact_fax, contact_web, contact_profile) VALUES
...
mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO history (history_contact, history_date, history_status) VALUES
(
	".$cid.",
	".time().",
	1
