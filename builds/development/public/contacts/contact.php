...
if (!$update && $_POST['contact_first']) {
  ...
  mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO contacts (contact_tags, contact_first, contact_last, contact_title, contact_image, contact_profile, contact_company, contact_street, contact_city, contact_state, contact_country, contact_zip, contact_phone, contact_cell, contact_email, contact_web, contact_updated, contact_user) VALUES 
...
$cid = ((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);
...
do {
	...
	if ($_POST['contact_f_'].$row_fields['field_id']) {
		...
		if (!empty($fv)) {
		mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO fields_assoc (cfield_field, cfield_contact, cfield_value) VALUES
...
} while ($row_fields = mysqli_fetch_assoc($fields));
...
$value = trim($value);
	...
	if ($value) {
		mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM tags WHERE tag_description = '".addslashes($value)."'");
		mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO tags (tag_description) VALUES
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO tags_assoc (itag_contact, itag_tag) VALUES
	(
		'".$cid."',
		'".$tid."'
	)
...
mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE contacts SET
...
//add extra fields
mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM fields_assoc WHERE cfield_contact = ".$_GET['id']."");
record_set('fields',"SELECT * FROM fields ORDER BY field_title ASC");
do {
...
//insert tags
mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM tags_assoc WHERE itag_contact = ".$_GET['id']."");
$tags = str_replace("","",addslashes($_POST['contact_tags']));
$tags = explode(",",$tags);
...
<?php } while ($row_fields = mysqli_fetch_assoc($fields)); ?>
<!--end custom fields-->
