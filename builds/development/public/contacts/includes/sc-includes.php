...
((bool)mysqli_query( $contacts, "USE " . $database_contacts));
...
function get_option ($opt)  {
   $query =  mysqli_query($GLOBALS["___mysqli_ston"], "SELECT option_value FROM options WHERE option_title = '".$opt."'");
   $result = mysqli_fetch_array($query);
   return $result['option_value'];
}
//

$contactcount = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM contacts") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
$contactcount = mysqli_num_rows($contactcount);
