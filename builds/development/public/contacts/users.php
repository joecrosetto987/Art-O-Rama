...
mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO users (user_level, user_email, user_password, user_home) VALUES
...
if ($_POST['user_email'] && $update) {
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE users SET 
		user_level = '".$ulevel."',
...
<?php $row_count++; } while ($row_users = mysqli_fetch_assoc($users)); ?>
