...
ob_start();
session_start();
$res = mysqli_query($GLOBALS["___mysqli_ston"], "SHOW TABLE STATUS LIKE 'users'") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
...
<?php 
mysqli_query($GLOBALS["___mysqli_ston"], "CREATE TABLE `contacts` (
...
mysqli_query($GLOBALS["___mysqli_ston"], "CREATE TABLE `fields` (
...
mysqli_query($GLOBALS["___mysqli_ston"], "CREATE TABLE `fields_assoc` (
...
mysqli_query($GLOBALS["___mysqli_ston"], "CREATE TABLE `users` (
...
mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `users` (`user_id`, `user_level`, `user_email`, `user_password`, `user_date`, `user_home`) VALUES (1, 1, '".trim($_POST['email'])."', '".trim($_POST['password'])."', NULL, 'index.php')");

mysqli_query($GLOBALS["___mysqli_ston"], "CREATE TABLE `history` (
...
mysqli_query($GLOBALS["___mysqli_ston"], "CREATE TABLE `notes` (
...
mysqli_query($GLOBALS["___mysqli_ston"], "CREATE TABLE `tags` (
...
mysqli_query($GLOBALS["___mysqli_ston"], "CREATE TABLE `tags_assoc` (
...
$usercheck = mysqli_query( $contacts, $query_usercheck) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
